...
par(mfrow=c(1,2))
boxplot(withoutBugs[,2],log = "y", main="Modules without bugs", ylab="McCabe Score",pars=list(ylim=c(1,500)))
boxplot(withBugs[,2],log = "y", main="Modules with bugs", ylab="McCabe Score",pars=list(ylim=c(1,500)))